...
(NULL, 'Neutro', 'N', 'Neutro é a tendência dos indivíduos que preferem não se envolver em questões morais e não tomar partido, fazendo o que aparenta ser melhor conforme o momento. O povo lagarto, nutis druidas e diversos humanos são neutros.'),
